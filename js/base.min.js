if (!function(a, b, c) {
        ...
        for (var i in k)
            if (k.hasOwnProperty(i)) {
                ...
                f = 0; f < a.length; f++)
                    g = a[f],
                    h = g.split("."),
                    1 === h.length ? m[h[0]] = e : (!m[h[0]] || m[h[0]] instanceof Boolean || (m[h[0]] = new Boolean(m[h[0]])),
                    m[h[0]][h[1]] = e),
                    j.push((e ? "" : "no-") + h.join("-"))
            }
    }
    function f(a) {
        ...
        m._config.enableClasses && (b += " " + c + a.join(" " + c),
...
!function(a, b) {
    ...
    c.prototype = {
        init: function() {
            ...
            f(this.element.value) && this.$element.height(this.element.scrollHeight - c),
            this.$element.on("input keyup", function() {
                var d = a(b)
                  , e = d.scrollTop();
                a(this).height(0).height(this.scrollHeight - c),
                d.scrollTop(e)
            })
        }
    },
...
function(a) {
    ...
    function b(b, d) {
        return this.each(function() {
            var e = a(this)
              , f = e.data("bs.menu")
              , g = a.extend({}, c.DEFAULTS, e.data(), "object" == typeof b && b);
            f || e.data("bs.menu", f = new c(this,g)),
            "string" == typeof b ? f[b](d) : g.show && f.show(d)
        })
    }
    var c = function(b, c) {
    ...
    c.DEFAULTS = a.extend({}, a.fn.modal.Constructor.DEFAULTS, {}),
    c.TRANSITION_DURATION = 300,
    c.TRANSITION_DURATION_BACKDROP = 150,
    c.prototype = a.extend({}, a.fn.modal.Constructor.prototype),
    c.prototype.backdrop = function(b) {
        var d = this;
        if (this.isShown && this.options.backdrop) {
            var e = a.support.transition;
            if (this.$backdrop = a(document.createElement("div")).addClass("menu-backdrop").appendTo(this.$body),
            this.$element.on("click.dismiss.bs.menu", a.proxy(function(a) {
                return this.ignoreBackdropClick ? void (this.ignoreBackdropClick = !1) : void (a.target === a.currentTarget && ("static" == this.options.backdrop ? this.$element[0].focus() : this.hide()))
            }, this)),
    ...
    c.prototype.hide = function(b) {
        ...
        a.support.transition ? this.$element.one("bsTransitionEnd", a.proxy(this.hideModal, this)).emulateTransitionEnd(c.TRANSITION_DURATION) : this.hideModal())
    }
    ,
    c.prototype.hideModal = function() {
        var a = this;
    ...
    c.prototype.show = function(b) {
        ...
        this.isShown || e.isDefaultPrevented() || (this.isShown = !0,
        this.escape(),
        this.$element.on("click.dismiss.bs.menu", '[data-dismiss="menu"]', a.proxy(this.hide, this)),
    ...
    var d = a.fn.menu;
    a.fn.menu = b,
    a.fn.menu.Constructor = c,
    a.fn.menu.noConflict = function() {
        return a.fn.menu = d,
        this
    }
    ,
    a(document).on("click.bs.menu.data-api", '[data-toggle="menu"]', function(c) {
        ...
        d.is("a") && c.preventDefault(),
        f.one("show.bs.menu", function(a) {
            a.isDefaultPrevented() || (f.attr("tabindex", "-1"),
            f.one("hidden.bs.menu", function() {
                d.is(":visible") && d.trigger("focus")
            }))
        }),
        b.call(f, g, this)
    ...
    function b(f, g, i, m) {
        ...
        function q() {
            B.$holder.on({
                ...
                x.closeOnSelect && B.close(!0)) : c.clear ? (B.clear(),
                x.closeOnClear && B.close(!0)) : c.close && B.close(!0)
            })
        }
        function r() {
            var b;
            x.hiddenName === !0 ? (b = f.name,
            f.name = "") : (b = ["string" == typeof x.hiddenPrefix ? x.hiddenPrefix : "", "string" == typeof x.hiddenSuffix ? x.hiddenSuffix : "_submit"],
            b = b[0] + f.name + b[1]),
        ...
        function u(a) {
            var b = a.keyCode
              , c = /^(8|46)$/.test(b);
            return 27 == b ? (B.close(!0),
            !1) : void ((32 == b || c || !w.open && B.component.key[b]) && (a.preventDefault(),
            a.stopPropagation(),
        ...
        var v = !1
          ...
          , B = A.prototype = {
            ...
            start: function() {
                ...
                B.$root = a('<div class="' + y.picker + '" id="' + f.id + '_root" />'),
                p(),
            ...
            render: function(b) {
                return b ? (B.$holder = a(n()),
                q(),
                B.$root.html(B.$holder)) : B.$root.find("." + y.box).html(B.component.nodes(w.open)),
                B.trigger("render")
            },
            stop: function() {
            ...
            open: function(c) {
                ...
                c !== !1 && (w.open = !0,
                v && k.css("overflow", "hidden").css("padding-right", "+=" + d()),
                s(),
                j.on("click." + w.id + " focusin." + w.id, function(a) {
                    var b = a.target;
                    ...
                    var d = c.keyCode
                      , e = B.component.key[d]
                      , f = c.target;
                    27 == d ? B.close(!0) : f != B.$holder[0] || !e && 13 != d ? a.contains(B.$root[0], f) && 13 == d && (c.preventDefault(),
                    f.click()) : (c.preventDefault(),
                    e ? b._.trigger(B.component.key.go, B, [b._.trigger(e)]) : B.$root.find("." + y.highlighted).hasClass(y.disabled) || (B.set("select", B.component.item.highlight),
                    x.closeOnSelect && B.close(!0)))
                })),
                B.trigger("open"))
            },
            close: function(a) {
                return a && (x.editable ? f.focus() : (B.$holder.off("focus.toOpen").focus(),
                setTimeout(function() {
            ...
            set: function(b, c, d) {
                ...
                b) {
                    ...
                    for (e in h)
                        f = h[e],
                        e in B.component.item && (void 0 === f && (f = null ),
            ...
            off: function() {
                ...
                namesCount = c.length; a < namesCount; a += 1)
                    b = c[a],
                    b in w.methods && delete w.methods[b];
                return B
            },
...
function(a) {
    ...
    function b(b) {
        return this.each(function() {
            ...
            e || d.data("bs.pickdate", e = new c(this,f)),
            e.show()
        })
    }
    var c = function(b, c) {
    ...
    var d = a.fn.pickdate;
    a.fn.pickdate = b,
    a.fn.pickdate.Constructor = c,
    a.fn.pickdate.noConflict = function() {
        return a.fn.pickdate = d,
        this
    }
}(jQuery),
function(a) {
    ...
    function b(b) {
        return this.each(function() {
            ...
            e ? a(".snackbar-inner").length && !a(".snackbar-inner.old").length ? (a(".snackbar-inner.in").addClass("old"),
            e.hide(),
            a.support.transition ? a(document).one("bsTransitionEnd", ".snackbar-inner.old", function() {
                d.data("bs.snackbar", e = new c(f)),
                e.show()
            }) : (d.data("bs.snackbar", e = new c(f)),
            e.show())) : a(".snackbar-inner").length || (d.data("bs.snackbar", e = new c(f)),
            e.show()) : (d.data("bs.snackbar", e = new c(f)),
            e.show())
        })
    }
    var c = function(b) {
        this.options = b,
        this.$element = a('<div class="snackbar-inner">' + this.options.content + "</div>")
    }
    ;
    c.DEFAULTS = {
        alive: 6e3,
    ...
    c.prototype.hide = function() {
        ...
        a.support.transition ? this.$element.one("bsTransitionEnd", function() {
            b.options.hide(b.options),
            b.$element.remove()
        }) : (b.options.hide(b.options),
        b.$element.remove()),
        this.fbtn("0")
    ...
    c.prototype.show = function() {
        var b = this;
        a(".snackbar").length || a(document.body).append('<div class="snackbar"></div>'),
        this.$element.appendTo(".snackbar").show().addClass(function() {
            ...
            b.$element.on("mouseenter", function() {
    ...
    var d = a.fn.snackbar;
    a.fn.snackbar = b,
    a.fn.snackbar.Constructor = c,
    a.fn.snackbar.noConflict = function() {
        return a.fn.snackbar = d,
        this
    }
}(jQuery),
function(a) {
    ...
    a.fn.tabSwitch = function(b) {
        ...
        if (void 0 !== b && void 0 !== b[0]) {
            ...
            b.offset().left > f && (e.addClass("reverse"),
            e.one("webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend", function() {
...
function(a) {
    ...
    function c(b) {
        return this.each(function() {
            var c = a(this)
              ...
              , f = a.extend({}, d.DEFAULTS, c.data(), "object" == typeof b && b);
            !e && f.toggle && /show|hide/.test(b) && (f.toggle = !1),
            e || c.data("bs.tile", e = new d(this,f)),
            "string" == typeof b && e[b]()
        })
    }
    var d = function(b, c) {
        ...
        this.transitioning = null ,
        this.$element = a(b),
        this.options.parent && (this.$parent = this.getParent()),
        this.options.toggle && this.toggle()
    }
    ;
    if (!a.fn.collapse)
    ...
    d.prototype = a.extend({}, a.fn.collapse.Constructor.prototype),
    ...
    d.prototype.show = function() {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(e && e.length && (b = e.data("bs.tile"),
            b && b.transitioning))) {
                var f = a.Event("show.bs.tile");
                if (this.$element.trigger(f),
                !f.isDefaultPrevented()) {
                    e && e.length && (c.call(e, "hide"),
                    b || e.data("bs.tile", null ));
                    var g = this.dimension();
    ...
    var e = a.fn.tile;
    a.fn.tile = c,
    a.fn.tile.Constructor = d,
    a.fn.tile.noConflict = function() {
        return a.fn.tile = e,
        this
    }
    ,
...
!function(a, b) {
    ...
    function h(a, b, c, d) {
        if (c) {
            d.classList.remove("waves-wrapping"),
    ...
    var k = k || {}
      ...
      , o = {
        ...
        show: function(a, b, c) {
            ...
            d.className = "waves-wrap waves-wrapping",
            b.appendChild(d);
            ...
            var h = f(b)
              , i = 0
              , j = 0;
            "touches" in a && a.touches.length ? (i = a.touches[0].pageY - h.top,
            j = a.touches[0].pageX - h.left) : (i = a.pageY - h.top,
            j = a.pageX - h.left),
            j = j >= 0 ? j : 0,
            i = i >= 0 ? i : 0;
            var k = "scale(" + b.clientWidth / 100 * 3 + ")"
              , l = "translate(0,0)";
            c && (l = "translate(" + c.x + "px, " + c.y + "px)"),
            e.setAttribute("data-hold", Date.now()),
            e.setAttribute("data-x", j),
            e.setAttribute("data-y", i),
            e.setAttribute("data-scale", k),
            e.setAttribute("data-translate", l);
            var m = {
                top: i + "px",
                left: j + "px"
            };
            e.classList.add("waves-notransition"),
            e.setAttribute("style", g(m)),
            e.classList.remove("waves-notransition"),
            m["-webkit-transform"] = k + " " + l,
            m["-moz-transform"] = k + " " + l,
            m["-ms-transform"] = k + " " + l,
            m["-o-transform"] = k + " " + l,
            m.transform = k + " " + l,
            ...
            m["-webkit-transition-duration"] = n + "ms",
            m["-moz-transition-duration"] = n + "ms",
            m["-o-transition-duration"] = n + "ms",
            m["transition-duration"] = n + "ms",
            e.setAttribute("style", g(m))
        },
        hide: function(a, b) {
            b = b || this;
            for (var c = b.getElementsByClassName("waves-wrapping"), d = b.getElementsByClassName("waves-rippling"), e = 0, f = d.length; f > e; e++)
                h(a, b, d[e], c[e])
        }
    }
      , p = {
